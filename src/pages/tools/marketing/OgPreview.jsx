        ...
        <ToolPageLayout toolId="social-mockup">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
                ...
                <div className="flex bg-slate-100 p-1 rounded-xl">
                    ...
                    >
                        <Facebook size={18} /> {t('tools.social-mockup.platforms.facebook')}
                    </button>
                    <button
                    ...
                    >
                        <Twitter size={18} /> {t('tools.social-mockup.platforms.twitter')}
                    </button>
                    <button
                    ...
                    >
                        <Linkedin size={18} /> {t('tools.social-mockup.platforms.linkedin')}
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm space-y-6">
                    <div>
                        <label className="block text-sm font-bold text-slate-700 mb-1">{t('tools.social-mockup.form.title')}</label>
                        <input
                            type="text"
                            value={data.title}
                    ...
                    <div>
                        <label className="block text-sm font-bold text-slate-700 mb-1">{t('tools.social-mockup.form.description')}</label>
                        <textarea
                            rows={3}
                    ...
                    <div>
                        <label className="block text-sm font-bold text-slate-700 mb-1">{t('tools.social-mockup.form.image')}</label>
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <div className="w-full bg-slate-100 border-2 border-dashed border-slate-300 rounded-xl py-3 flex items-center justify-center gap-2 text-slate-500 font-bold text-sm hover:bg-slate-200 transition-colors">
                                    <ImageIcon size={18} /> {t('tools.social-mockup.form.upload')}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <label className="block text-sm font-bold text-slate-700 mb-1">{t('tools.social-mockup.form.domain')}</label>
                        <input
                            type="text"
                            value={data.url}
                        ...
                        <div className="bg-white max-w-[500px] w-full border border-slate-200 shadow-sm overflow-hidden">
                            <div className="aspect-[1.91/1] bg-slate-200 w-full relative group overflow-hidden">
                                {data.image ? (
                                    ...
                                    <div className="flex items-center justify-center h-full text-slate-400">{t('tools.social-mockup.preview.noImage')}</div>
                                )}
                            </div>
                    ...
                    {platform === 'twitter' && (
                        <div className="bg-white max-w-[500px] w-full rounded-2xl border border-slate-100 overflow-hidden shadow-sm">
                             <div className="aspect-[2/1] bg-slate-200 w-full relative overflow-hidden">
                                ...
                                <div className="absolute bottom-2 left-2 bg-black/60 text-white text-xs px-1 rounded">{t('tools.social-mockup.preview.promoted')}</div>
                            </div>
