        ...
        <ToolPageLayout>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-slate-900">Hashtag Generator</h1>
                        <p className="text-slate-500 text-sm">Find trending hashtags to boost your reach.</p>
                    </div>
                </div>
            </div>
            ...
            <RelatedTools currentToolId="hashtag-gen" categoryId="content" />
        </ToolPageLayout>
    );
}
