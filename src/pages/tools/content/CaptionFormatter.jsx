        ...
        <ToolPageLayout>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                    <label className="block text-sm font-bold text-slate-700">Draft Your Caption</label>
                    <textarea 
                        value={input}
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-4 bg-indigo-50 rounded-xl text-xs text-indigo-800 border border-indigo-100 flex items-start gap-2">
                         ...
                         <p>
                             <strong>Pro Tip:</strong> Paste the result directly into Instagram. The invisible characters maintain your paragraphs.
                         </p>
                    </div>
                </div>
            </div>
